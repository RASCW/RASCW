...
Begin VB.Form frmscatterSC1 
   Caption         =   "Scattergram - Ranking"
   ClientHeight    =   8265
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11760
   ...
   Begin OlectraChart2D.Chart2D ChartScatter 
      ...
      _ExtentY        =   13547
      _StockProps     =   0
      ControlProperties=   "frmscatter.frx":0442
   End
   ...
   End
End
Attribute VB_Name = "frmscatterSC1"
...
Dim size As Integer
If (frmscatterSC1.Height > 360) And (frmscatterSC1.Height - 360 < frmscatterSC1.Width / 1.5) Then
   size = frmscatterSC1.Height - 360
ElseIf (frmscatterSC1.Height > 360) And (frmscatterSC1.Height - 360 > frmscatterSC1.Width / 1.5) Then
   size = frmscatterSC1.Width / 1.5
Else
   size = 0
End If
