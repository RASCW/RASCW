...
Begin VB.Form frmscatterDE1 
   Caption         =   "CASC Scattergram - Ranking"
   ClientHeight    =   8505
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11760
   Icon            =   "frmscatterDE.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8505
   ScaleWidth      =   11760
   ...
   Begin OlectraChart2D.Chart2D ChartScatter 
      ...
      _ExtentY        =   13547
      _StockProps     =   0
      ControlProperties=   "frmscatterDE.frx":04B8
   End
   ...
   End
End
Attribute VB_Name = "frmscatterDE1"
...
Dim size As Integer
If (frmscatterDE1.Height > 360) And (frmscatterDE1.Height - 360 < frmscatterDE1.Width / 1.5) Then
   size = frmscatterDE1.Height - 360
ElseIf (frmscatterDE1.Height > 360) And (frmscatterDE1.Height - 360 > frmscatterDE1.Width / 1.5) Then
   size = frmscatterDE1.Width / 1.5
Else
   size = 0
End If
