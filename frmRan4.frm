...
Begin VB.Form frmRan4 
   AutoRedraw      =   -1  'True
   Caption         =   "Event Ranges - Scaling"
   ClientHeight    =   8820
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12750
   Icon            =   "frmRan4.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8820
   ScaleWidth      =   12750
   ...
   Begin OlectraChart2D.Chart2D ChartRan2 
      ...
      _ExtentY        =   13785
      _StockProps     =   0
      ControlProperties=   "frmRan4.frx":0442
   End
End
Attribute VB_Name = "frmRan4"
...
FileNum = FreeFile
If txt_file_range2 <> "" Then
Open CurDir + "\" + txt_file_range2 For Input As FileNum
Else
...
Private Sub Form_Activate()
    If (Check2 <> "") And (txt_file_range2 <> "") Then
        startup
        OpenFile
...
'    If (txt_file_range2 <> "") And (Check2 <> "") Then
'        startup
'        OpenFile
'        'checking = False
'    End If
...
Private Sub Form_Resize()
    Dim size As Integer
    If (frmRan4.Height > 360) And (frmRan4.Height - 360 < frmRan4.Width / 1.5) Then
       size = frmRan4.Height - 360
    ElseIf (frmRan4.Height > 360) And (frmRan4.Height - 360 > frmRan4.Width / 1.5) Then
       size = frmRan4.Width / 1.5
    Else
       size = 0
    End If
