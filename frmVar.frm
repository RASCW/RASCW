...
Begin VB.Form frmVar1 
   Appearance      =   0  'Flat
   Caption         =   "Variance Analysis - Ranking"
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11010
   ...
   Begin OlectraChart2D.Chart2D Chartvar2 
      ...
      _ExtentY        =   6720
      _StockProps     =   0
      ControlProperties=   "frmVar.frx":0442
   End
   Begin OlectraChart2D.Chart2D ChartVar1 
      ...
      _ExtentY        =   6800
      _StockProps     =   0
      ControlProperties=   "frmVar.frx":0B28
   End
...
Private Sub Form_Resize()
    Dim size As Integer
    If (frmVar1.Height > 600) And (frmVar1.Height - 600 < frmVar1.Width / 1.5) Then
       size = frmVar1.Height - 600
    ElseIf (frmVar1.Height > 600) And (frmVar1.Height - 600 > frmVar1.Width / 1.5) Then
       size = frmVar1.Width / 1.5
    Else
       size = 0
    End If
