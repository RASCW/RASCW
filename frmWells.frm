...
If total_well.Text <> "" And Total_event.Text <> "" Then
        ...
        max_well_num = Int(Trim(total_well.Text))
        max_event_num = Int(Trim(Total_event.Text))
        ...
        For I = 1 To max_event_num
            ...
            event_numbers(I) = txtevent(I).Text
            End If
            Next I
         If OptProb.Value = False And OptObs.Value = False And OptNormal.Value = False Then
           ...
           Exit Sub
         End If
           prob_opt = OptProb.Value
           obs_opt = OptObs.Value
           norm_opt = OptNormal.Value
        testing_flag = 1
     ...
     If k > 20 Then
      ...
      Else
            ...
            For I = 0 To List_add_events.ListCount - 1
               ...
               event_names(k) = Trim(Mid(List_add_events.List(I), 11, Len(List_add_events.List(I)) - 10))   'add_events_name(I + 1)
...
Private Sub Form_Load()
        ...
        If modifyflag = 1 Then
         total_well.Text = Str(max_well_num)
         Total_event.Text = Str(max_event_num)
           For I = 1 To max_event_num
              event_label(I - 1).Visible = True
              txtevent(I).Text = Str(event_numbers(I))
              txtevent(I).Visible = True
           Next I
            For I = 1 To max_well_num
            well_label(I - 1).Visible = True
            well(I).Text = Str(well_numbers(orders(I)))
            well(I).Visible = True
            Next I
               If prob_opt = 1 Then
                OptProb.Value = True
...
ReDim well_label_used(1 To act_Num_well)
...
For I = 1 To act_Num_well
    add_well_num(I) = -1
    add_well_name(I) = "**"
    well_label_used(I) = "Well No." + Str(I)
Next I
...
For I = 1 To act_Num_well       'every wells
    ...
    ' well_label_used(I) = add_well_name(I)
    ' skip 4 lines
           Input #FileNum, Temp
           Input #FileNum, Temp
           Input #FileNum, Temp
