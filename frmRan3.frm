...
Begin VB.Form frmRan3 
   ...
   Begin OlectraChart2D.Chart2D ChartRan1 
      ...
      _ExtentY        =   13785
      _StockProps     =   0
      ControlProperties=   "frmRan3.frx":0442
   End
End
Attribute VB_Name = "frmRan3"
...
Private Sub cmdOpen_Click()
    ...
    'cmdOpen.Enabled = False
     ...
     If txt_file_ran1 = "" Then
          ...
          Exit Sub
     End If
     Check2 = txt_file_ran1
     txt_file_range2 = txt_file_ran1
...
Dim size As Integer
If (frmRan3.Height > 360) And (frmRan3.Height - 360 < frmRan3.Width / 1.5) Then
   size = frmRan3.Height - 360
ElseIf (frmRan3.Height > 360) And (frmRan3.Height - 360 > frmRan3.Width / 1.5) Then
   size = frmRan3.Width / 1.5
Else
   size = 0
End If
